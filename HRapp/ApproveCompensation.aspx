<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveCompensation.aspx.cs" Inherits="HRapp.ApproveCompensation" %>
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="header-section">
                <h2>Approve Compensation Leave Requests</h2>
                <hr />
                <p class="description">
                    Enter the Request ID. The system will validate the original work hours and replacement status before Approving or Rejecting.
                </p>
            </div>
