<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyCompensation.aspx.cs" Inherits="HRapp.ApplyCompensation" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <p class="description">Request a day off in exchange for an extra day previously worked.</p>

            <asp:Label ID="lblMessage" runat="server" CssClass="message-label"></asp:Label>

            <div class="form-card">
                <label>Date You Want Off (Compensation Date):</label>
                <asp:TextBox ID="txtCompDate" runat="server" TextMode="Date"></asp:TextBox>

                <label>Date You Worked Extra (Original Work Day):</label>
