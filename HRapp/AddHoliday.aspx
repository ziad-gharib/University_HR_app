<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddHoliday.aspx.cs" Inherits="HRapp.AddHoliday" %>
        ...
        <div class="page-container">
            ...
            <div class="form-card">
                ...
                <div class="button-center">
                    <asp:Button ID="btnSubmit" runat="server" Text="Add Holiday" OnClick="addHoliday" CssClass="btn-submit" />
                </div>
            </div>
        </div>
    </form>
