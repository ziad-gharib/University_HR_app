    ...
    public partial class ApplyMedical : System.Web.UI.Page
    {
        ...
        protected void submitLeave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    // Using the stored procedure Submit_medical from Section 2.5 (k)
                    ...
                    // @medical_type (Must be 'sick' or 'maternity' based on check constraint)
                    ...
                    lblMessage.Text = "Success: Medical leave application submitted.";
