<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveUnpaid.aspx.cs" Inherits="HRapp.ApproveUnpaid" %>
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="header-section">
                <h2>Approve Unpaid Leave Requests</h2>
                <hr />
                <p class="description">
                    Enter the Request ID. The system will validate the request (checking annual balance, duration limits, etc.) and update the status.
                </p>
            </div>
