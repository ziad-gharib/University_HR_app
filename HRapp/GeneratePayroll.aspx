<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneratePayroll.aspx.cs" Inherits="HRapp.GeneratePayroll" %>
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="header-section">
                ...
                <hr />
                <p class="description">Enter the pay period dates to calculate and finalize the salary for a specific employee.</p>
            </div>
            ...
            <div style="text-align: center;">
                <div class="form-card">
                    ...
                    <div class="button-center">
                        <asp:Button ID="btnGenerate" runat="server" Text="Generate Payroll" OnClick="generatePayroll" CssClass="btn-generate" />
                    </div>
                </div>
            </div>
        </div>
