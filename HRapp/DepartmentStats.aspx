<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentStats.aspx.cs" Inherits="HRapp.DepartmentStats" %>
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="grid-container">
                <asp:GridView ID="gridDeptStats" runat="server" 
                    AutoGenerateColumns="true" 
                    EmptyDataText="No department data found."
                    CellPadding="0" 
                    GridLines="None"
                    CssClass="grid-view">
                </asp:GridView>
