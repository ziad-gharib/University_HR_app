<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedLeaves.aspx.cs" Inherits="HRapp.RejectedLeaves" %>
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="grid-container">
                <asp:GridView ID="gridRejected" runat="server" 
                    AutoGenerateColumns="true" 
                    EmptyDataText="No rejected leaves found."
                    CellPadding="0" 
                    GridLines="None"
                    CssClass="grid-view">
                </asp:GridView>
