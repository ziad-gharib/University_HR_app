<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplaceEmployee.aspx.cs" Inherits="HRapp.ReplaceEmployee" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <h2>Assign Replacement Employee</h2>
            <hr />

            <asp:Label ID="lblMessage" runat="server" CssClass="message-label"></asp:Label>

            <div class="form-card">
                <label>Employee ID (To be replaced):</label>
                ...
                <div class="button-center">
                    <asp:Button ID="btnReplace" runat="server" Text="Assign Replacement" OnClick="replaceEmployee" CssClass="btn-replace" />
                </div>
            </div>
        </div>
    </form>
