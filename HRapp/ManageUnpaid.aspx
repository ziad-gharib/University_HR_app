<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageUnpaid.aspx.cs" Inherits="HRapp.ManageUnpaid" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Unpaid Leaves</title>
    <style>
        * {
    ...
    <form id="form1" runat="server">
        <div class="page-container">
            ...
            <div class="header-section">
                <h2>Manage Unpaid Leave Requests</h2>
                <hr />
                <p class="description">
                    (For Deans, Vice-Deans, and Presidents only)
                </p>
                <p class="description-text">Enter the Leave Request ID to process. The system will validate and Approve/Reject based on university policy.</p>
            </div>
