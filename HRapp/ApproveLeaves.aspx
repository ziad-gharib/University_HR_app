<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveLeaves.aspx.cs" Inherits="HRapp.ApproveLeaves" %>
    ...
    <form id="form2" runat="server">
        <div class="page-container">
            ...
            <div class="header-section">
                ...
                <hr />
                <p class="description">
                    Enter the Request ID. The system will automatically check the employee's balance and Approve or Reject the request.
                </p>
            </div>
